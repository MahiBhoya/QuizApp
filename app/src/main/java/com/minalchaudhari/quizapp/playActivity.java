...
import static com.minalchaudhari.quizapp.R.*;
...
public class playActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_choose1 = findViewById(id.btn_choose1);
        btn_choose2 = findViewById(id.btn_choose2);
        btn_choose3 = findViewById(id.btn_choose3);
        btn_choose4 = findViewById(id.btn_choose4);
        btn_next = findViewById(id.btn_next);

        findViewById(id.image_back).setOnClickListener(
                a-> finish()
        );
        remplirData();
                ...
                view -> {
                    if (isclickBtn){
                        ...
                        if(!valueChoose.equals(correct_list[currentQuestion])){
                            ...
                            btn_click.setBackgroundResource(drawable.background_btn_erreur);

                        }else {
                            Toast.makeText(playActivity.this , "correct",Toast.LENGTH_LONG).show();
                            btn_click.setBackgroundResource(drawable.background_btn_correct);
                        ...
                        new Handler().postDelayed(() -> {
                            if(currentQuestion!=question_list.length-1){
                                ...
                                remplirData();
                                valueChoose = "";
                                btn_choose1.setBackgroundResource(drawable.background_btn_choose);
                                btn_choose2.setBackgroundResource(drawable.background_btn_choose);
                                btn_choose3.setBackgroundResource(drawable.background_btn_choose);
                                btn_choose4.setBackgroundResource(drawable.background_btn_choose);
    ...
    void chooseBtn(){
        ...
        btn_click.setBackgroundResource(drawable.background_btn_choose);
        isclickBtn = true;
